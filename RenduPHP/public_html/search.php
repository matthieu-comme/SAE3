...
<body>
	<?php include('inc/header.php'); ?>	
		...
		<table id='tab'>
			...
			<tr><td><a href="search.php?id=10">Les jouets demandés par les enfants qui ont moins de x ans.</a></a></td></tr>
			<tr><td><a href="search.php?id=11">Quels sont les jouets produits par les ateliers qui ont fabriqué le jouet J ?</a></a></td></tr>
			...
			<tr><td><a href="search.php?id=14">Quels sont les jouets pouvant substituer le jouet J ?</a></a></td></tr>
			<tr><td><a href="search.php?id=15">Qui sont les elfes qui entretiennent le traineau T ?</a></a></td></tr>
		</table>   
	</section>
<?php 
if(isset($_GET['id'])) {
